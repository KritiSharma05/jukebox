...
public class podcast
{
    ...
    public void display() throws SQLException, ClassNotFoundException {
        ...
        System.out.println("pod id"+"  "+"podcast name");
        while(r.next())
        {
    ...
    /*public void displayid () throws SQLException, ClassNotFoundException, UnsupportedAudioFileException, IOException, LineUnavailableException {
        Connection con=getcon();
        Statement s=con.createStatement();
        System.out.println("Enter the podcast id :");
        int pname =obj.nextInt();
        sid=pname;
        ResultSet r=s.executeQuery("select * from podcast where pdid='"+pname+"'");
        ...
        ResultSet r1=s.executeQuery("select eid,ename,artist from episode where pdid='"+pname+"'");
        System.out.println("eid"+"  "+"episode name"+"  "+"artist");
        while(r1.next())
        {
        ...
        String e=obj.next();
        ResultSet r2 = s.executeQuery("select paths from episode ,podcast where eid='" + e + "'");
        while (r2.next())
        {
            path = r2.getString(1);
            File f = new File(path);
